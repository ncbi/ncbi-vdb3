...
namespace ncbi
{
    ...
    TEST ( JWKTest, to_public )
    {
        JWKRef priv_key;
        // the RSA key in JSON text
        String priv_key_json (
            "{"
            "\"alg\" : \"RS256\","
            "\"d\"   : \"et5GFZq4feyMe9w6UwqPLAh19rloTsYHb0P26kl7vHfJ4JJN4Wq_EmoBWQI1iQmuDTcID6Yf8L3oJGu6m6Geo0LvqWYInBIei5zH8j1WKLtp_f4aiXG7oda3HP7Z5TMSAD2WWJkzVFeJvspuViIemtRjcQhqKKDMyis2GF_rSicB0Yww542RR-Jx33RB1HscvDn7S4nm9iAv2T9f_0yy8tTkAxX3RZ6zW81QnJmRnDpOWchb8S98bH2bekMsv3GHGa5KmK1_5-r1iBkDz_TtXg8iCnj1Zy51tSoFO5kwBbhOCFJXUFuO9m8ydhfyHAQUmofPiYkRaTaA_LmmLje9cQ\","
            "\"dp\"  : \"WNtyzE8GH2bV3Lqj2ADIS0O076r61M_xJn708BiKl9Av54vPT2pyfEFwFLrvwVxVV5f6CTgs2bNiOg5q92qpuGALsGhnXfA74oeqCw5bsty-uNf1dm6Q8msTbwEy6dvpAHZe_xI9HvDUYjqHKk0ztLk4JIXfILs16N7VXp_kD6E\","
            "\"dq\"  : \"qYYi7Qqur5M0lYtq45X4QfoNzssp09XijZzo2zU1d_qq-JML-Lm0Hxeudf-BFYkjTM1WSSCEFdaqNfEMqs5As8-AE5q6kJ3Dy6oosai1SOOP84ARz_m62L7zTb1ja2TcL3GxC7P8ePlggWPP4BrpmvR7ssXoin-Mj85P4pKyk-8\","
            "\"e\"   : \"AQAB\","
            "\"kid\" : \"kid_1\","
            "\"kty\" : \"RSA\","
            "\"n\"   : \"ycT6oVUJ9ALqMw1JKqS6ZigNfbcwKxhr8_zvWxIOpo7rWo5Uc-cj4l8Z6kBugXrdnfqojeEQ8k3J_cEKe9dy2-O3smTwqdMaD463J_Bm-vY47p-cfnI5o4eKQHqw9AsAl5ZHR7f5-uzaXiD9tq8iziVPG4LidGR8vpCS5Ds3packQ1tsRjWo2poqJwm8wCddQwd6PNKUQfsa-XRmgaxMpKZpKCQGYJhtbC0J8nXn_GEMJadCICWgrr99pESUE2KbUa33mxjeVWuBeK8u1roglmlIlX-DnWzzwnDg0Gy39B7Mocm4UPjeP1Ay0zbih8Kh003qim9kngEAW5z5kxOqWw\","
            "\"p\"   : \"8_wtj1tzmw91YH5Pvc7WNp10blg8D7trdE9oHVGAPWFtyPPunbqam2928whqA_2rWjIKvQ1-Xk1wP6ymskclDrwK_Ol5RJjWtuOax2ptlh7-IRtPkS7M0-V2j_Hy0ZwRSzObJsEbV3TcCZk4YglU1tLKOAJxE4u4I5MCKSg6g5k\","
            "\"q\"   : \"07SbCvgSWlK5a_zIVKZTCRRp-hUqFq6UsWzWqIfFkM7s93fdDUgWo3Iws6lrE03Lub0ExyivSvnPVDAwcvF5sf_fY9_GnD-c7BKT5QVdnUzAfKV5FKCfKBUr31vdrmPaf5KTbxrOZhvIig2Owidk-1UBOwTKt9GONZX1G0bK1hM\","
            "\"qi\"  : \"VUNbYsPNKl03B4JIXr45CLfTjB9br1rbuyQ3vNhCUUeL7cxK9VaweB831WbkvEkc3X1rKS-91Vd5CPQ8p9u6ik79cgVTe-R8GWCj4KgmqUX0_GD--zJ2_yOIEXee6WS4Y_68TyzYkHmZ1yXkIFBUJJAxUxIa75ycOppxkGBJmtk\","
            "\"use\" : \"sig\""
            "}"
            );

        priv_key = JWKMgr :: parseJWK ( priv_key_json );
        EXPECT_EQ ( priv_key -> isPrivate (), true );

        
        JWKRef pub_key = priv_key -> toPublic ();
        EXPECT_EQ ( pub_key -> isPrivate (), false );
    }
    ...
    TEST ( JWKSetTest, add_key )
    {
        ...
        key = JWKMgr :: parseJWK ( priv_key_json );
        EXPECT_NE ( key, nullptr );

        {
            JWKSetRef kset = JWKMgr :: makeJWKSet ();
            EXPECT_NE ( kset, nullptr );

            EXPECT_EQ ( key . unique (), true );
            EXPECT_EQ ( key . use_count (), 1 );
            kset -> addKey ( key );
            EXPECT_EQ ( key . unique (), false );
