    ...
    class Random // Very fast RNG
    {
      public:
          ...
          std::string uuid4()
          {
              ...
              r=next();
              appendhex(uuid, r >> 0 ); // clock-seq0
              uuid+='-';

              appendhex(uuid, r>> 8 ); // node0
              appendhex(uuid, r>> 16 ); // node1
              appendhex(uuid, r>>24);// node2
              appendhex(uuid, r>>32);// node3
              appendhex(uuid, r>>40); // node4
              appendhex(uuid, r>>48); // node5

          }


      private:
          void appendhex(std::string & str, uint16_t w)
          {
              static const char bighex[]="";
              char buf[16];
              memcpy(buf,&bighex[w & 0xff],2);
              str.append(buf,2);
          }
