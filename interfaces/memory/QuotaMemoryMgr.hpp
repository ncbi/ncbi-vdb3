...
public:
    ...
    */
    QuotaMemoryMgr( TrackingMemoryManagerItf * base_mgr, size_type quota );
...
public:
     ...
     */
    size_type quota() const noexcept { return m_quota; }
     ...
     */
    size_type total_free() const noexcept { return m_quota - m_used; }

    /**
     * Current amount of memory allocated through this instance.
     * @return Currently allocated memory, in bytes
     */
    size_type total_used() const noexcept { return m_used; }
     ...
     */
    size_type max_free() const noexcept { return total_free(); }
...
protected:
    ...
    */
    void set_quota ( size_type new_quota ) { m_quota = new_quota; }
...
private:
    ...
    */
    void handle_quota_update( size_t min_extension );
